...
import martialArtsQuiz from '../../question_crypto/arts_matiaux';
import { motion, AnimatePresence } from 'framer-motion';

export default function MartialArtsQuiz() {
    ...
    const handleAnswerClick = (selectedOption) => {
        ...
        if (selectedOption === martialArtsQuiz[currentQuestion].correctAnswer) {
            setScore(prevScore => prevScore + 100);
        }

        setTimeout(() => {
            const nextQuestion = currentQuestion + 1;
            if (nextQuestion < martialArtsQuiz.length) {
    ...
    const getButtonColor = (option) => {
        ...
        if (option.charAt(0) === martialArtsQuiz[currentQuestion].correctAnswer) {
    ...
    if (!martialArtsQuiz || martialArtsQuiz.length === 0) {
        return (
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <p className="text-xl text-center text-red-500 font-bold">Bonnes réponses : <span className="font-bold text-violet-600">{score / 100} sur {martialArtsQuiz.length}</span></p>
    ...
    const currentQuestionData = martialArtsQuiz[currentQuestion];
                ...
                <div className="p-6">
                    <div className="flex justify-between items-center mb-6">
                        <div className="text-2xl font-bold text-violet-800">
                            Question {currentQuestion + 1} / {martialArtsQuiz.length}
                        </div>
                        <motion.div 
