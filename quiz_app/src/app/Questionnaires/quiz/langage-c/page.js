...
import cQuiz from '../../question_crypto/langage_c';
...
export default function CQuiz() {
    ...
    const handleAnswerClick = (selectedOption) => {
        ...
        if (selectedOption === cQuiz[currentQuestion].correctAnswer) {
            setScore(prevScore => prevScore + 100);
        }

        setTimeout(() => {
            const nextQuestion = currentQuestion + 1;
            if (nextQuestion < cQuiz.length) {
    ...
    const getButtonColor = (option) => {
        ...
        if (option.charAt(0) === cQuiz[currentQuestion].correctAnswer) {
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <p className="text-xl text-center text-red-500 font-bold">Bonnes réponses : <span className="font-bold text-violet-600">{score / 100} sur {cQuiz.length}</span></p>
    ...
    const currentQuestionData = cQuiz[currentQuestion];
                ...
                <div className="p-6">
                    <div className="flex justify-between items-center mb-6">
                        <div className="text-2xl font-bold text-violet-800">
                            Question {currentQuestion + 1} / {cQuiz.length}
                        </div>
                        <motion.div 
