...
import sportsQuiz from '../../question_crypto/sport';
...
export default function SportsQuiz() {
    ...
    const handleAnswerClick = (selectedOption) => {
        ...
        if (selectedOption === sportsQuiz[currentQuestion].correctAnswer) {
            setScore(prevScore => prevScore + 100);
        }

        setTimeout(() => {
            const nextQuestion = currentQuestion + 1;
            if (nextQuestion < sportsQuiz.length) {
    ...
    const getButtonColor = (option) => {
        ...
        if (option.charAt(0) === sportsQuiz[currentQuestion].correctAnswer) {
    ...
    if (!sportsQuiz || sportsQuiz.length === 0) {
        return (
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <p className="text-xl text-center text-red-500 font-bold">Bonnes réponses : <span className="font-bold text-violet-600">{score / 100} sur {sportsQuiz.length}</span></p>
    ...
    const currentQuestionData = sportsQuiz[currentQuestion];
                ...
                <div className="p-6">
                    <div className="flex justify-between items-center mb-6">
                        <div className="text-2xl font-bold text-violet-800">
                            Question {currentQuestion + 1} / {sportsQuiz.length}
                        </div>
                        <motion.div 
