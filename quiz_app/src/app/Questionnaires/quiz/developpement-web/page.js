...
import webDevQuiz from '../../question_crypto/développement_web';
...
export default function WebDevQuiz() {
    ...
    const handleAnswerClick = (selectedOption) => {
        ...
        if (selectedOption === webDevQuiz[currentQuestion].correctAnswer) {
            setScore(prevScore => prevScore + 100);
        }

        setTimeout(() => {
            const nextQuestion = currentQuestion + 1;
            if (nextQuestion < webDevQuiz.length) {
    ...
    const getButtonColor = (option) => {
        ...
        if (option.charAt(0) === webDevQuiz[currentQuestion].correctAnswer) {
    ...
    if (!webDevQuiz || webDevQuiz.length === 0) {
        return (
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <p className="text-xl text-center text-red-500 font-bold">Bonnes réponses : <span className="font-bold text-violet-600">{score / 100} sur {webDevQuiz.length}</span></p>
    ...
    const currentQuestionData = webDevQuiz[currentQuestion];
                ...
                <div className="p-6">
                    <div className="flex justify-between items-center mb-6">
                        <div className="text-2xl font-bold text-violet-800">
                            Question {currentQuestion + 1} / {webDevQuiz.length}
                        </div>
                        <motion.div 
