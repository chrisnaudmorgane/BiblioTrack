...
import videoGamesQuiz from '../../question_crypto/jeux_videos';
...
export default function VideoGamesQuiz() {
    ...
    const handleAnswerClick = (selectedOption) => {
        ...
        if (selectedOption === videoGamesQuiz[currentQuestion].correctAnswer) {
            setScore(prevScore => prevScore + 100);
        }

        setTimeout(() => {
            const nextQuestion = currentQuestion + 1;
            if (nextQuestion < videoGamesQuiz.length) {
    ...
    const getButtonColor = (option) => {
        ...
        if (option.charAt(0) === videoGamesQuiz[currentQuestion].correctAnswer) {
    ...
    if (!videoGamesQuiz || videoGamesQuiz.length === 0) {
        return (
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <p className="text-xl text-center text-red-500 font-bold">Bonnes réponses : <span className="font-bold text-violet-600">{score / 100} sur {videoGamesQuiz.length}</span></p>
    ...
    const currentQuestionData = videoGamesQuiz[currentQuestion];
                ...
                <div className="p-6">
                    <div className="flex justify-between items-center mb-6">
                        <div className="text-2xl font-bold text-violet-800">
                            Question {currentQuestion + 1} / {videoGamesQuiz.length}
                        </div>
                        <motion.div 
