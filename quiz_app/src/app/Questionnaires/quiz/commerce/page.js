...
import commerce from '../../question_crypto/commerce';
...
export default function Commerce() {
    ...
    const handleAnswerClick = (selectedOption) => {
        ...
        if (selectedOption === commerce[currentQuestion].correctAnswer) {
            setScore(prevScore => prevScore + 100);
        }

        setTimeout(() => {
            const nextQuestion = currentQuestion + 1;
            if (nextQuestion < commerce.length) {
    ...
    const getButtonColor = (option) => {
        ...
        if (option.charAt(0) === commerce[currentQuestion].correctAnswer) {
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <p className="text-xl text-center text-red-500 font-bold">Bonnes réponses : <span className="font-bold text-violet-600">{score / 100} sur {commerce.length}</span></p>
    ...
    const currentQuestionData = commerce[currentQuestion];
                ...
                <div className="p-6">
                    <div className="flex justify-between items-center mb-6">
                        <div className="text-2xl font-bold text-violet-800">
                            Question {currentQuestion + 1} / {commerce.length}
                        </div>
                        <motion.div 
